...
function setup() {
	...
	bob1 = Bodies.circle(320, 250, 40, bob_options);
	World.add(world,bob1);
    
    bob2 = Bodies.circle(360, 250, 40, bob_options);
	World.add(world,bob2);

	bob3 = Bodies.circle(400, 250, 40, bob_options);
	World.add(world,bob3);

	bob4 = Bodies.circle(440, 250, 40, bob_options);
	World.add(world,bob4);

	bob5 = Bodies.circle(480, 250, 40, bob_options);
